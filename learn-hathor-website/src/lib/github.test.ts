...
import { getLatestReleaseTag, createLatestReleaseGetter } from './github';
...
describe('GitHub API utilities', () => {
  ...
  describe('createLatestReleaseGetter', () => {
    it('should return a function that fetches the latest release', async () => {
      ...
      const branchResolver = createLatestReleaseGetter('owner/repo');
